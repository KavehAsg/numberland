...
function WbNavbar(props, ref) {
  ...
  return (
    <div className="w-full" ref={ref}>
      ...
      >
        <button type="button" onClick={menuHandler} ref={menuRef}>
          {isMenuOpen ? (
        ...
        <ul
          ...
          } flex flex-col gap-4 bg-white text-wbMenuItem text-xl font-bold transition-opacity duration-150 z-30 p-8 rounded-xl shadow-custom`}
