...
export default function WbFooter() {
  return (
    <div className="footer-container mt-24 py-16 px-8">
      ...
      {/* footer copy right */}
      <span className="block mt-24 text-center text-neutral  text-sm md:text-base">تمامی حقوق برای نامبرلند محفوظ است.</span>
    </div>
  );
}
