...
export default function BlogLayout() {
  ...
  const scrollToTop = () => navbarRef.current.scrollIntoView({
    behavior : "smooth"
  });
  ...
  return (
    <div className="w-full font-numberland ">
      ...
      <button id="scroll-to-top" className="btn fixed bottom-14 left-14 btn-ghost btn-circle bg-black hover:bg-neutral"
      onClick={scrollToTop}>
